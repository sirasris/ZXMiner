...
// multi-threading class for ProteinProcessor
public class ProteinProcessorThread implements Runnable
{
    ...
    public ProteinProcessorThread(SynchronizedTreeMap[] globalResult, ArrayList<ProteinStruct> proteins, ThreadLimitStruct scope, ParamStruct param)
   	{
